...
def _build_nltha_sheet_importers(
    ...
    importers = build_common_sheet_importers(import_context)
    # NLTHA overrides quad rotations to use project-level story ordering
    importers["get_quad_rotations"] = lambda parsed, allowed_cases: _import_quad_rotations(
        import_context,
        parsed[0],
        parsed[1],
