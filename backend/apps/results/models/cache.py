...
class GlobalResultsCache(models.Model):
    ...
    project = models.ForeignKey(Project, on_delete=models.CASCADE, related_name="global_cache")
    result_set = models.ForeignKey(
        ResultSet, on_delete=models.CASCADE, null=True, blank=True, related_name="global_cache"
    )

    # Result type: Drifts, Accelerations, Forces, Displacements + direction suffix
    result_type = models.CharField(max_length=50)

    story = models.ForeignKey(Story, on_delete=models.CASCADE, related_name="global_cache")
...
class ElementResultsCache(models.Model):
    ...
    project = models.ForeignKey(Project, on_delete=models.CASCADE, related_name="element_cache")
    result_set = models.ForeignKey(
        ResultSet, on_delete=models.CASCADE, null=True, blank=True, related_name="element_cache"
    )

    # Result type with direction: WallShears_V2, ColumnShears_V3, etc.
    result_type = models.CharField(max_length=50)

    element = models.ForeignKey(Element, on_delete=models.CASCADE, related_name="element_cache")
    story = models.ForeignKey(Story, on_delete=models.CASCADE, related_name="element_cache")
...
class JointResultsCache(models.Model):
    ...
    project = models.ForeignKey(Project, on_delete=models.CASCADE, related_name="joint_cache")
    result_set = models.ForeignKey(
        ResultSet, on_delete=models.CASCADE, null=True, blank=True, related_name="joint_cache"
    )
...
class AbsoluteMaxMinDrift(models.Model):
    ...
    project = models.ForeignKey(Project, on_delete=models.CASCADE, related_name="maxmin_drifts")
    result_set = models.ForeignKey(
        ResultSet, on_delete=models.CASCADE, related_name="maxmin_drifts"
    )
    story = models.ForeignKey(Story, on_delete=models.CASCADE, related_name="maxmin_drifts")
    load_case = models.ForeignKey(LoadCase, on_delete=models.CASCADE, related_name="maxmin_drifts")
...
class TimeSeriesGlobalCache(models.Model):
    ...
    project = models.ForeignKey(Project, on_delete=models.CASCADE, related_name="time_series_cache")
    result_set = models.ForeignKey(
        ResultSet, on_delete=models.CASCADE, related_name="time_series_cache"
    )
    ...
    story = models.ForeignKey(Story, on_delete=models.CASCADE, related_name="time_series_cache")
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=["project", "result_set", "load_case_name", "result_type", "direction"]
            ),
            models.Index(fields=["story"]),
        ]
