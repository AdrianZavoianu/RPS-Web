...
class StoryDriftSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StoryDrift
        fields = [
            'id', 'story', 'story_name', 'load_case', 'load_case_name',
            'direction', 'drift', 'max_drift', 'min_drift', 'story_sort_order'
        ]
...
class StoryAccelerationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'story', 'story_name', 'load_case', 'load_case_name',
            'direction', 'acceleration', 'max_acceleration', 'min_acceleration',
            'story_sort_order'
        ]
...
class StoryForceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'story', 'story_name', 'load_case', 'load_case_name',
            'direction', 'location', 'force', 'max_force', 'min_force',
            'story_sort_order'
        ]
...
class StoryDisplacementSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'story', 'story_name', 'load_case', 'load_case_name',
            'direction', 'displacement', 'max_displacement', 'min_displacement',
            'story_sort_order'
        ]
