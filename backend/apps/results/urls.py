...
urlpatterns = [
    ...
    path(
        '<slug:project_slug>/results/elements/',
    ...
    path(
        '<slug:project_slug>/results/maxmin/',
        MaxMinDataView.as_view(),
        name='maxmin-data'
    ),
    ...
    path(
        '<slug:project_slug>/results/chart/',
    ...
    # Pushover cases
    path(
        '<slug:project_slug>/pushover-cases/',
        PushoverCasesView.as_view(),
        name='pushover-cases'
    ),
    ...
    path(
        '<slug:project_slug>/global/',
        GlobalResultsView.as_view(),
        name='global-results-raw'
    ),
]
