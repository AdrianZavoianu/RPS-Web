...
import { useElementsForType } from '../../../hooks/useResults'
...
import { ComparisonResultTypeNode, TreeCategoryTypeNode, TreeLeafNode } from './TreePrimitives'
import { isComparisonSelection, type TreeAvailableTypes, type TreeSelection } from './types'

export interface ComparisonSetNodeProps {
...
export function ComparisonSetNode({
  comparisonSet: cs,
  projectSlug,
  availableTypes,
  currentSelection,
